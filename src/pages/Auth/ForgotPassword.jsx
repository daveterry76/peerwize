...
const ForgotPassword = () => {
    ...
    const handleResetEmail = (e) => {
        ...
        if (email === 'dave@gmail.com') {
            setSuccess("A password resent link has been sent to your mail box. Kindly open your email to reset password");
        ...
        <div className='auth__container'>
                ...
                <div className='auth__container--form'>
                    <form>
                        ...
                        />
                        {isLoading ? <img className='loading' src={loading} alt='loading' /> : null}
