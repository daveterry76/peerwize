  ...
  return (
    <>
            ...
            <div className='auth__container'>
                <h1>Sign up on <span>Peerwize</span></h1>
                <div>
                    <hr />
                    <h3>Already have an account? <span><Link to='/'>Login</Link></span></h3>
                    <hr />
                </div>    
                <div className='auth__container--form'>
                    <form>
                        ...
                        />
                        <select aria-label='label for country select' title='select'>
                            <option disabled selected>Country</option>
                            {countryValues.map((country) => (
                                <option>{country.label}</option>
                            ))}
                        </select>
                        <select aria-label='label for city select' title='select'>
                        ...
                        <div className='auth__container--password'>
                            ...
                            <svg onClick={handleShowCreatePassword} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="auth__container--show--password">
